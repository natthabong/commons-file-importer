...
public class DefaultFileLayoutConfigItem implements FileLayoutConfigItem {
	...
	public void setValidationRecordFieldConfig(FileLayoutConfigItem validationRecordFieldConfig) {
	...
	public int hashCode() {
		final int prime = 31;
		int result = 1;
		result = prime * result + ((calendarEra == null) ? 0 : calendarEra.hashCode());
		...
		result = prime * result + ((documentFieldName == null) ? 0 : documentFieldName.hashCode());
		result = prime * result + ((expectedValue == null) ? 0 : expectedValue.hashCode());
		result = prime * result + ((has1000Separator == null) ? 0 : has1000Separator.hashCode());
		result = prime * result + ((hasDecimalPlace == null) ? 0 : hasDecimalPlace.hashCode());
		result = prime * result + (isRequired ? 1231 : 1237);
		result = prime * result + (isTransient ? 1231 : 1237);
		result = prime * result + ((itemType == null) ? 0 : itemType.hashCode());
		result = prime * result + ((length == null) ? 0 : length.hashCode());
		result = prime * result + ((mappingToFieldName == null) ? 0 : mappingToFieldName.hashCode());
		result = prime * result + ((minusSymbol == null) ? 0 : minusSymbol.hashCode());
		result = prime * result + ((paddingCharacter == null) ? 0 : paddingCharacter.hashCode());
		...
		result = prime * result + ((signFlagConfig == null) ? 0 : signFlagConfig.hashCode());
		result = prime * result + ((startIndex == null) ? 0 : startIndex.hashCode());
		result = prime * result + ((validationRecordFieldConfig == null) ? 0 : validationRecordFieldConfig.hashCode());
	...
	public boolean equals(Object obj) {
		...
		if (calendarEra == null) {
			if (other.calendarEra != null)
				return false;
		} else if (!calendarEra.equals(other.calendarEra))
			return false;
		...
		if (documentFieldName == null) {
			if (other.documentFieldName != null)
				return false;
		} else if (!documentFieldName.equals(other.documentFieldName))
			return false;
	...
	public void setDocumentFieldName(String documentFieldName) {
