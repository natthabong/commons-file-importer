				...
				if (fileLayoutConfigItem.getValidationType() != null) {
					...
					if (fieldValidator != null) {
						...
						if (fileObserver != null) {
							if (observers.get(fileObserver.getRecordType()) == null) {
								observers.put(fileObserver.getRecordType(),
										new HashSet<FileObserver<?>>());
							}
							observers.get(fileObserver.getRecordType()).add(fileObserver);
